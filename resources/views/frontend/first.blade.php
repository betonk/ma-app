    ...
    <div class="container py-2">
        ...
        <div class="field p-4">
            <div class="row mt-4">
                ...
                <div class="col-6 align-self-end"><img class="w-100" src="{{ asset('./img/eva-01.svg') }}" alt="eva-01"></div>
            </div>
        </div>
        ...
        <section id="ftr">
            <div class="field-ftr p-5">
                ...
                <div class="flex my-2">
                    <a href="" class="text-decoration-none"><i class='ri-instagram-line' style="font-size: 1.5rem"></i></a>
                    <a href="" class="text-decoration-none"><i class='ri-whatsapp-line' style="font-size: 1.5rem"></i></a>
                </div>
