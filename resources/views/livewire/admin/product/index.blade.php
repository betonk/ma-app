                ...
                @foreach ($product as $item)
                    <tr class="align-middle">
                        ...
                        <td class="d-flex justify-content-center">
                            ...
                            <button type="button" class="btn text-primary border-0" wire:click="destroy({{ $item->id }})">
                    ...
                    <fieldset disabled="disabled">
                        <div class="mb-3">
                            ...
                            <input type="text" id="disabledTextInput" class="form-control"
                                value="{{ $data->name }}" placeholder="Disabled input">
                        </div>
                        <div class="mb-3">
                            <label for="disabledTextInput" class="form-label">kategori</label>
                            <input type="text" id="disabledTextInput" class="form-control"
                                placeholder="Disabled input" value="{{ $data->category->name }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('checkout/product/' . $data->gambar) }}" alt="" width="400"
