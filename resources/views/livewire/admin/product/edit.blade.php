            ...
            <form wire:submit.prevent="updateProduct" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" name="anime" id="anime" class="form-control @error('anime')is-invalid @enderror" wire:model="anime" value="{{ old('anime') }}" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" name="kode" id="kode" class="form-control @error('kode')is-invalid @enderror" wire:model="kode" value="{{ old('kode') }}" aria-describedby="emailHelp" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" name="desc" id="desc" class="form-control @error('desc')is-invalid @enderror" wire:model="desc" value="{{ old('desc') }}" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="number" name="regular_price" id="regular_price" class="form-control @error('regular_price')is-invalid @enderror" wire:model="regular_price" value="{{ old('regular_price') }}" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="number" name="harga_jual" id="harga_jual" class="form-control @error('harga_jual')is-invalid @enderror" wire:model="harga_jual" value="{{ old('harga_jual') }}" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="number" name="quantity" id="quantity" class="form-control @error('quantity')is-invalid @enderror" wire:model="quantity" value="{{ old('quantity') }}" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="file" name="gambar" id="" class="form-control" wire:model="new_image" />
                        @if ($new_image)
                        <img src="{{ $new_image->temporaryUrl() }}" alt="" width="120">
                        @else
                        <img src="{{ asset('checkout/product/') }}/{{ $gambar }}" alt="" width="120">
                        @endif
